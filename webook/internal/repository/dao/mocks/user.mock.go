...
import (
	...
	dao "github.com/CAbrook/golang_learning/internal/repository/dao"
...
func (m *MockUserDao) GetProfileById(ctx context.Context, userId int64) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDaoMockRecorder) GetProfileById(ctx, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProfileById", reflect.TypeOf((*MockUserDao)(nil).GetProfileById), ctx, userId)
}
